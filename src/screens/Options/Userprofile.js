...
// import * as localStorage from '../../servies/loco';
...
export default function Userprofile() {
  ...
  const [token, settoken] = useState('1243214')
  ...
  useEffect(() => {
    ...
    const restoringSession = async () => {
      ...
      // if (userData) {
        ...
        let newtoken = userData.verifyStatus;
        
        // userData = JSON.parse(userData);
        
        console.log('Token 123', newtoken);
        console.log('userData1', userData);
        settoken(userData);
        console.log('userData2', userData.verifyStatus);
  ...
  const Getprofile = async images => {
    //  console.log('final image', images);
    const response = await fetchService.getprofile(
      // customerType,
      // token,
      // address,
      // email_id,
    ...
    if (response.status) {
      ...
      //     userData.customer_image = images;
